...
FacebookClient.prototype.postPhotoOnPage = function(visitorsName, image) {
    ...
    return this.postPagePhoto({
        url: image,
        message: !visitorsName || !visitorsName.length ? "L'équipe de VVF Villages vient de passer un petit bonjour" : "L'équipe de VVF Villages vient de dire un petit bonjour à " + visitorsName.join(", "),
        place: pageId,
        no_story: true,
