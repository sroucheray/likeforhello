...
WebServer.prototype.setupPublicApp = function() {
    ...
    //this.publicApp.use(express.static("app/admin/public/"));
    //this.publicApp.use("/scripts", express.static("app/public/views/admin/helpers/"));
    this.publicApp.use("/lib", express.static("bower_components"));
    ...
    this.publicApp.get("/vvf-villages-like-you", function(req, res) {
        ...
        if (isMobile) {
            ...
            res.render("https://www.facebook.com/VVFVillages.pageofficielle/app_708032399246642");
        }
    });
